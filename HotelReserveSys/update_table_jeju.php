...
<html lang="kor" dir="ltr">
  ...
  <script type="text/javascript">
    ...
    function reload(){
      ...
      location.href='./update_table_jeju.php?num_people='+num_people+'&check_in_date='+check_in+'&check_out_date='+check_out+'&hotel_id=seoul';
    }
  </script>

  <body class="center">
    <form class="reservation" action="./update_table_jeju.php" method="GET">
      <h1 align="center">제주점 예약하기</h1>
    ...
    <center>
    <form action = "./reserve_room.php?num_people=<? echo $num_peo ?>&check_in=<?echo $check_in?>&check_out=<?echo $check_out?>&hotel_id=jeju" method="POST">
